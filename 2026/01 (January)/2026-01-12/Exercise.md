...
1. `get_number_of_plants(2, "hectares", "lettuce")` should return `100000`.
1. `get_number_of_plants(20, "acres", "soybeans")` should return `161874`.
1. `get_number_of_plants(3.75, "hectares", "tomatoes")` should return `150000`.
1. `get_number_of_plants(16.75, "acres", "tomatoes")` should return `271139`.
