...
1. `is_valid_domino_chain([[6, 2], [3, 4], [4, 1]])` should return `False`.
1. `is_valid_domino_chain([[2, 5], [5, 6], [5, 1]])` should return `False`.
1. `is_valid_domino_chain([[4, 3], [3, 1], [1, 6], [6, 6], [6, 5], [5, 1], [1, 1], [1, 4], [4, 4], [4, 2]])` should return `True`.
1. `is_valid_domino_chain([[2, 3], [3, 3], [3, 6], [6, 1], [1, 4], [3, 5], [5, 5], [5, 4], [4, 2], [2, 2]])` should return `False`.
