...
1. `daylight_hours(0)` should return `12`.
1. `daylight_hours(-90)` should return `24`.
1. `daylight_hours(-10)` should return `12`.
1. `daylight_hours(23)` should return `10`.
1. `daylight_hours(88)` should return `0`.
1. `daylight_hours(-33)` should return `13`.
1. `daylight_hours(70)` should return `2`.
